...
document.addEventListener("DOMContentLoaded", function() {
  ...
  div.innerHTML = sliderTemplate({
    items: [
      ...
      { title: "Of course, it’s not just in Egypt and the Middle East",
        subtitle: "in a remarkably short time, the exuberance surrounding the spread of liberalism",
        about: "Overall, the number of liberal democracies in the world has been in steady decline for a decade. According to Freedom House, 71 countries last year saw declines in their political rights and freedoms; only 35 saw improvements.",
        description: "- Early years (2010–12)",
      },
      { title: "While the crisis of democracy has many causes",
        subtitle: "social media platforms have come to seem like a prime culprit",
        about: "Western democracy, but also an automated media landscape that rewards demagoguery with clicks. Political opinions have become more polarized, populations have become more tribal, and civic nationalism is disintegrating.",
